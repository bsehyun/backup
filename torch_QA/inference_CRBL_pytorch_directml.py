...
from model_pytorch_directml import create_model, get_device
...
weight_path = "./weights/CRBL_250328_pytorch_directml.pth"
...
class InferenceModel:
    """Inference wrapper for CRBL model with DirectML support"""
